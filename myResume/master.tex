...
\begin{document}
	...
	\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
		...
		\href{www.linkedin.com/in/rexford-acquah-58a084234}{\uline{LinkedIn}} $|$ % row = 2, col = 1
		\href{https://github.com/ReedBanks}{\uline{GitHub}} $|$ % row = 2, col = 1
		\href{https://leetcode.com/jane-doe}{\uline{Leetcode}} & % row = 2, col = 1
		Email: \href{mailto:rexxstark20@gmail.com}{\uline{rexxstark20@gmail.com}} $|$ % row = 2, col = 2
		\uline{Mobile}: 050 990 1282 $/$ 054 656 8371 \\ % row = 2, col = 2
	\end{tabular*}
	%--------------------------------------------
