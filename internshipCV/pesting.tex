% Personally am dividing my resume into 2
% Master resume => contains all gathered skills and achievements so far
% Specific named resume => This will be tailored for application for a specific position
...
\begin{document}
	...
	\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
		\textbf{\Huge Rexford Acquah \vspace{2pt}} & % row = 1, col = 1
		%	Location: Anycity, Anystate, Anycountry \\ % row = 1, col = 2
		%	\href{https://jane-doe.com}{\uline{jane-doe.com}} $|$ % row = 2, col = 1
		\\
		\href{https://linkedin.com/in/rexford-acquah-58a084234}{\uline{LinkedIn}} $|$ % row = 2, col = 1
		\href{https://github.com/ReedBanks}{\uline{GitHub}} $|$ % row = 2, col = 1
		%	\href{https://leetcode.com/jane-doe}{\uline{Leetcode}} & % row = 2, col = 1
		\uline{Email}: \href{mailto:rexxstark20@gmail.com}{rexxstark20@gmail.com} $|$ % row = 2, col = 2
		\uline{Mobile}: +233 50 990 1282 % $/$ 054 656 8371 \\ % row = 2, col = 2
	\end{tabular*}
	%--------------------------------------------
	...
	\resumeItemListEnd{}
	\resumeHeadingListEnd{}
	%-----------PENDING PROJECTS TO BE FINISHED -----------%
	%1.selenium webscrapper 2. malware using python 3.malware for mobile 4. network project
	%--------------------------------------------
